...
export default async function Home() {
  ...
  return (
    <div className="grid grid-cols-4 grid-rows-[auto_repeat(4,1fr)] gap-4 mt-8">
      <div className="col-span-4 bg-white rounded-lg flex p-4 items-center justify-center border-border border-2">
        <h1 className="text-2xl text-brand-foreground font-bold">Welcome back, {user?.name || 'User'}!</h1>
      </div>
      <div className="col-span-2 row-span-4 row-start-2 bg-white p-8 rounded-lg flex flex-col border-border border-2">
      ...
      <div className="col-start-3 row-start-2 flex flex-col justify-center items-center gap-1 p-4 bg-white rounded-lg border-border border-2">
      ...
      <div className="col-start-4 row-start-2 flex flex-col justify-center items-center gap-1 p-4 bg-white rounded-lg border-border border-2">
      ...
      <div className="col-span-2 col-start-3 row-start-3 flex flex-col justify-center items-center gap-1 p-4 bg-white rounded-lg border-border border-2">
      ...
      <div className="col-span-2 row-span-2 col-start-3 row-start-4 flex flex-col justify-center items-center gap-1 p-4 bg-white rounded-lg border-border border-2">
